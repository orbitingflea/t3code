...
export const T3CODE_CODEX_SKILL_ROOT_ENV = "T3CODE_CODEX_SKILL_ROOT";
...
export const resolveCodexSkillRoot = (environment: NodeJS.ProcessEnv = process.env) =>
  environment[T3CODE_CODEX_SKILL_ROOT_ENV]?.trim() || undefined;
